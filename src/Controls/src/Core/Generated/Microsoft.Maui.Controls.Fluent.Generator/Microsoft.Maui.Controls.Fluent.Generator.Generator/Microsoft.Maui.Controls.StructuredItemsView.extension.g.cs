...
namespace Microsoft.Maui.Controls
{
    ...
    public static class StructuredItemsViewGeneratedExtension
    {
        ...
        public static T ItemsLayout<T>(this T obj,
            System.Func<LazyValueBuilder<Microsoft.Maui.Controls.IItemsLayout>, LazyValueBuilder<Microsoft.Maui.Controls.IItemsLayout>> buidValue)
            where T : Microsoft.Maui.Controls.StructuredItemsView
        {
            var builder = buidValue(new LazyValueBuilder<Microsoft.Maui.Controls.IItemsLayout>());
            if (builder.ValueIsSet()) obj.ItemsLayout = builder.GetValue();
            return obj;
        }
        ...
        public static T ItemSizingStrategy<T>(this T obj,
            System.Func<LazyValueBuilder<Microsoft.Maui.Controls.ItemSizingStrategy>, LazyValueBuilder<Microsoft.Maui.Controls.ItemSizingStrategy>> buidValue)
            where T : Microsoft.Maui.Controls.StructuredItemsView
        {
            var builder = buidValue(new LazyValueBuilder<Microsoft.Maui.Controls.ItemSizingStrategy>());
            if (builder.ValueIsSet()) obj.ItemSizingStrategy = builder.GetValue();
            return obj;
        }
