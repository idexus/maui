...
namespace Microsoft.Maui.Controls
{
    ...
    public static class GraphicsViewGeneratedExtension
    {
        ...
        public static T Drawable<T>(this T obj,
            System.Func<LazyValueBuilder<Microsoft.Maui.Graphics.IDrawable>, LazyValueBuilder<Microsoft.Maui.Graphics.IDrawable>> buidValue)
            where T : Microsoft.Maui.Controls.GraphicsView
        {
            var builder = buidValue(new LazyValueBuilder<Microsoft.Maui.Graphics.IDrawable>());
            if (builder.ValueIsSet()) obj.Drawable = builder.GetValue();
            return obj;
        }
