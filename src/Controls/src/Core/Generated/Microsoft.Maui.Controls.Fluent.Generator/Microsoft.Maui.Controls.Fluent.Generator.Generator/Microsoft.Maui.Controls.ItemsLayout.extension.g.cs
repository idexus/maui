...
namespace Microsoft.Maui.Controls
{
    ...
    public static class ItemsLayoutGeneratedExtension
    {
        ...
        public static T SnapPointsAlignment<T>(this T obj,
            System.Func<LazyValueBuilder<Microsoft.Maui.Controls.SnapPointsAlignment>, LazyValueBuilder<Microsoft.Maui.Controls.SnapPointsAlignment>> buidValue)
            where T : Microsoft.Maui.Controls.ItemsLayout
        {
            var builder = buidValue(new LazyValueBuilder<Microsoft.Maui.Controls.SnapPointsAlignment>());
            if (builder.ValueIsSet()) obj.SnapPointsAlignment = builder.GetValue();
            return obj;
        }
        ...
        public static T SnapPointsType<T>(this T obj,
            System.Func<LazyValueBuilder<Microsoft.Maui.Controls.SnapPointsType>, LazyValueBuilder<Microsoft.Maui.Controls.SnapPointsType>> buidValue)
            where T : Microsoft.Maui.Controls.ItemsLayout
        {
            var builder = buidValue(new LazyValueBuilder<Microsoft.Maui.Controls.SnapPointsType>());
            if (builder.ValueIsSet()) obj.SnapPointsType = builder.GetValue();
            return obj;
        }
