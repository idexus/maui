...
namespace Microsoft.Maui.Controls
{
    ...
    public static class ColumnDefinitionGeneratedExtension
    {
        ...
        public static Microsoft.Maui.Controls.ColumnDefinition Width(this Microsoft.Maui.Controls.ColumnDefinition obj,
            System.Func<LazyValueBuilder<Microsoft.Maui.GridLength>, LazyValueBuilder<Microsoft.Maui.GridLength>> buidValue)
        {
            var builder = buidValue(new LazyValueBuilder<Microsoft.Maui.GridLength>());
            if (builder.ValueIsSet()) obj.Width = builder.GetValue();
            return obj;
        }
