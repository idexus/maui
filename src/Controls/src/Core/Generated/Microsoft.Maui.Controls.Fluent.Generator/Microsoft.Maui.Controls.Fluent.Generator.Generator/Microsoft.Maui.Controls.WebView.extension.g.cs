...
namespace Microsoft.Maui.Controls
{
    ...
    public static class WebViewGeneratedExtension
    {
        ...
        public static T Cookies<T>(this T obj,
            System.Func<LazyValueBuilder<System.Net.CookieContainer>, LazyValueBuilder<System.Net.CookieContainer>> buidValue)
            where T : Microsoft.Maui.Controls.WebView
        {
            var builder = buidValue(new LazyValueBuilder<System.Net.CookieContainer>());
            if (builder.ValueIsSet()) obj.Cookies = builder.GetValue();
            return obj;
        }
        ...
        public static T Source<T>(this T obj,
            System.Func<LazyValueBuilder<Microsoft.Maui.Controls.WebViewSource>, LazyValueBuilder<Microsoft.Maui.Controls.WebViewSource>> buidValue)
            where T : Microsoft.Maui.Controls.WebView
        {
            var builder = buidValue(new LazyValueBuilder<Microsoft.Maui.Controls.WebViewSource>());
            if (builder.ValueIsSet()) obj.Source = builder.GetValue();
            return obj;
        }
