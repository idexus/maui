...
namespace Microsoft.Maui.Controls
{
    ...
    public static class SwipeGestureRecognizerGeneratedExtension
    {
        ...
        public static Microsoft.Maui.Controls.SwipeGestureRecognizer Direction(this Microsoft.Maui.Controls.SwipeGestureRecognizer obj,
            System.Func<LazyValueBuilder<Microsoft.Maui.SwipeDirection>, LazyValueBuilder<Microsoft.Maui.SwipeDirection>> buidValue)
        {
            var builder = buidValue(new LazyValueBuilder<Microsoft.Maui.SwipeDirection>());
            if (builder.ValueIsSet()) obj.Direction = builder.GetValue();
            return obj;
        }
        ...
        public static Microsoft.Maui.Controls.SwipeGestureRecognizer Threshold(this Microsoft.Maui.Controls.SwipeGestureRecognizer obj,
            System.Func<LazyValueBuilder<uint>, LazyValueBuilder<uint>> buidValue)
        {
            var builder = buidValue(new LazyValueBuilder<uint>());
            if (builder.ValueIsSet()) obj.Threshold = builder.GetValue();
            return obj;
        }
